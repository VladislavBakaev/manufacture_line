...
class MoveRobot(object):
    def __init__(self):
        ...
        self.current_joint_state = [0,0,0,0,0]
        self.current_temp = [0,0,0,0,0]
        self.current_load = [0,0,0,0,0]
        self.name_link = ['pal_joint_0','pal_joint_1','pal_joint_2','pal_joint_3','gripper']
...
def main():
    ...
    config_file = os.path.join(THIS_FOLDER, 'config_pal.json')
