...
def MoveToPointCallback(msg):
    x,y,z = ParseMsg(msg)
    roboticArm = DeltaRoboticArm()
    availJointState,goalJointStateTheory = roboticArm.InversProblem(x,y,z)
    goalJointState = (goalJointStateTheory[1],goalJointStateTheory[0],goalJointStateTheory[2])
